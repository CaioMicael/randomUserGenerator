export class estClassViewComportamento {
    ...
    initListeners() {
        ...
        if (buttoIncluir) {
            const caminho = "../lib/estClassFormulario.php?destino="+this.controller+"&Acao=1";
            const dados   = 'Cidade';
    ...
    buttonIncluirRegistroListener() {
        ...
        if (this.buttonIncluirRegistro) {
            this.buttonIncluirRegistro.addEventListener('click', () => {
                var oFetch = {};
                ...
                console.log(oFetch);
                this.doAjaxCarrega("../lib/estClassFormulario.php?destino="+this.controller+"&Acao=1&processaDados=1", oFetch);
            })
        }
    }
