 ...
 */
    ...
    isInputsRequiredVazios() {
        var bCondicao;
        var aInputs = this.oComponentes.getInputRequired();
     ...
     */
    checkboxUnicaSelecaoToDisabledButton(button, checkbox) {
 ...
 */
    checkboxUnicaSelecaoListener(aCheckbox) {
        if (aCheckbox) {
            aCheckbox.forEach(checkbox => {
                checkbox.addEventListener('change', () => {
                    this.setCheckboxCheckedFromNodeList(aCheckbox);
    ...
    buttonChangeDisabledTelaSelecionarListener() {
        if (this.oComponentes.getAllComponenteCheckboxTelaSelecionar()) {
            this.oComponentes.getAllComponenteCheckboxTelaSelecionar().forEach(checkbox => {
                checkbox.addEventListener('change', () => {
                    this.checkboxUnicaSelecaoToDisabledButton(this.oComponentes.getComponenteButtonSelecionar(),checkbox);
                })
            })
        }
    }
