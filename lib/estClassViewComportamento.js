    ...
    initListeners() {
        ...
        if (this.oComponentes.getComponenteButtonAlterar()) {
            this.oComponentes.getComponenteButtonAlterar().addEventListener('click', async () => {
                ...
                this.doAjaxCarregaTelaAlteracao(this.oFetch.getURLFetch(this.controller,2,0),0);
            })
        }
 ...
 */
     ...
     */
    static getListenerMensagem(bRefresh) {
        const instance = new estClassViewComportamento();
        instance.buttonOKListener(bRefresh);
        instance.buttonTraceListener();
    }
...
/**********************************************************************************************************************/ 
    ...
    async processaDadosIncluirAjax(caminho,dados) {
        ...
        //estClassViewComportamento.getListenerMensagem(this.oFetch.trataRetornoFetch(sRespostaFetch));
    }
    ...
    async processaDadosExcluirAjax(caminho,dados) {
        this.oFetch = new estClassViewFetch();
        var sRespostaFetch = await this.oFetch.doAjaxCarrega(caminho,dados);
        this.getListenerMensagem(this.oFetch.trataRetornoFetch(sRespostaFetch));
    }
