 ...
 */
    ...
    isInputsRequiredVazios() {
        ...
        aInputs.forEach(xInput => {
            if (xInput.innerHTML == null || xInput.innerHTML == '') {
            ...
            aCheckbox.forEach(checkbox => {
                checkbox.addEventListener('change', () => {
                    if (checkbox.checked == true) {
                        this.changeButtonDisabledFalse(this.oComponentes.getComponenteButtonSelecionar());
                    }
                    else {
                        this.changeButtonDisabled(this.oComponentes.getComponenteButtonSelecionar());
                    }
                })
            })
        }
