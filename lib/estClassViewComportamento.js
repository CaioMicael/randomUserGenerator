 ...
 */
    ...
    buttonTelaSelecionarListener() {
        ...
        this.checkboxChecked  = this.oComponentes.getLastElementFromNode('estCheckboxTableSelecionar');
    ...
    buttonLupaListener() {
        this.oComponentes.buttonLupa              = document.querySelector("[class=input-lupa]");
        this.oComponentes.nameInputLupaPreencher  = this.oComponentes.buttonLupa.id;
        if (this.oComponentes.buttonLupa && this.oComponentes.nameInputLupaPreencher) {
            this.oComponentes.buttonLupa.addEventListener('click', () => {
                this.oFetch = new estClassViewFetch;
